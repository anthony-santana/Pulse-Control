...
# IMPORTANT: ml_pulse_optimizer.py *MUST* be installed to the XACC python 
...
destFile = str(Path.home()) + '/.xacc/py-plugins/ml_pulse_optimizer.py'
shutil.copyfile('ml_pulse_optimizer.py', destFile) 
#########################################################################
import xacc, json
